...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    console.log(potatoes.totalPrice / potatoes.quantity)  // returns "$2.35"

// Write a function that takes in an array of numbers and returns an array of numbers from the original array that were evenly divisible by 13. If a number is not evenly divizible by 13, it should not be returned. If no elements within the array are evenly divisible by 13, the function should return an empty array.


const filteredArrays = getAllDivisibleByThirteen.filter(arr1) => {
        return getAllDivisibleByThirteen
}
